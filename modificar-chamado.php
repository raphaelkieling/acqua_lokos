		...
		<table>
			...
			<tr>
				...
				<td>
					...
					?>
					<input name="tipoProblema" value="Defeito" type="radio" <?php if($defeito == true){echo "checked";}?>>
			...
			<tr>
				...
				<td colspan="3"><input type="text" placeholder="Ex: Lentidão no Computador" name="problema_c" value="<?= $problema ?>" required></td>
			</tr>
			<tr>
				<th>Descrição</th>
				<td colspan="3">
					<textarea name="descricao_c" id="" cols="30" rows="10"required><?= $descricao ?></textarea>
				</td>
			</tr>
			<tr>
				<td></td>

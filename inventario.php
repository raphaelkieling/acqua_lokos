...
<body>
		...
		<div class="container section-home">
			...
			<table class="noveoito">
				...
				<tr>
					<td><input name="nome_c" type="text"></td>
					<td>
					...
					<td><input name="office" type="checkbox" value="0"></td>
					<td><input name="teamv" type="checkbox" value="0"></td>
					<td><input name="auto" type="checkbox" value="0"></td>
					<td><input name="queops" type="checkbox" value="0"></td>
				</tr>
				<tr>
					<th>Setor:</th>
					<td colspan="6">
				...
				<tr>
					<td colspan='7'><input type="Submit" value="Inventariar"></td>
				</tr>
			</table>
			<table class="bordb">
				<tr>
				...
				<tr>
					<td><?= $inventario['id'] ?></td>
					<td><?= $inventario['nome_c'] ?></td>
					<td><?= $inventario['nome'] ?></td>
					<td><?= $inventario['sistema'] ?></td>
					<td><?php if(isset($inventario['office']) && $inventario['office']=="1"){echo "Sim";}else{echo "-";} ?></td>
					<td><?php if(isset($inventario['teamv']) && $inventario['teamv']=="1"){echo "Sim";}else{echo "-";} ?></td>
					<td><?php if(isset($inventario['automatize']) && $inventario['automatize']=="1"){echo "Sim";}else{echo "-";} ?></td>
					<td><?php if(isset($inventario['queops']) && $inventario['queops']=="1"){echo "Sim";}else{echo "-";} ?></td>
					<td><?= $inventario['setor_i'] ?></td>
